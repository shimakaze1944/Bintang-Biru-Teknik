...
<body>
	...
	date_default_timezone_set("asia/jakarta");
	 ...
	 <table width="98%" style="margin-left: 10px;font-size: 14px" class="colom">
		<tr>
			<td colspan="7"><p class="center"><img src="image/logo_wtp.png" height="120px" width="320x" align="center" /></p></td>
...
$pdf = new HTML2PDF('L','A4','en',true,'UTF-8',array(10,5,1,5));
...
// $pdf->AddPage();
$pdf->WriteHTML($html);
$pdf->Output('Laporan-Servis.pdf','D');
?>
