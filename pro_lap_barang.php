...
<body>
	...
	| <a href="pro_lap_barang_pdf.php?lap_brg_serial=<?php echo $lap_brg_serial; ?>&lap_brg_id=<?php echo $lap_brg_id; ?>&lap_brg_ktg_id= <?php echo $lap_brg_ktg_id; ?>">Export Pdf</a> |
	<a href="pro_lap_barang_doc.php?lap_brg_serial=<?php echo $lap_brg_serial; ?>&lap_brg_id=<?php echo $lap_brg_id; ?>&lap_brg_ktg_id= <?php echo $lap_brg_ktg_id; ?>">Export Doc</a> |
	<a href="pro_lap_barang_xls.php?lap_brg_serial=<?php echo $lap_brg_serial; ?>&lap_brg_id=<?php echo $lap_brg_id; ?>&lap_brg_ktg_id= <?php echo $lap_brg_ktg_id; ?>">Export Excel</a> |
	<br />
	<br />
	 <table width="98%" style="margin-left: 10px;font-size: 14px" class="colom">
		<tr>
			...
			<!-- <td colspan="2" style="text-align: center"><h4><p class="padding" style="font-size: 1.5em">PT. WORLD TRANS</p></h4> -->
			<td colspan="3"><p class="right"><img src="image/iso.jpg" height="120px" width="250px" align="center" /></p></td>
