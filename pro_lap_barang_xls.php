...
<body>
	<?php 
	 ...
	 <table width="98%" style="margin-left: 10px;font-size: 14px;" class="colom table">
		<tr>
			<td colspan="3"><p class="center"><img src="<?php echo realpath('image/logo_wtp2.jpg'); ?>" height="120px" width="250px" align="center" /></p></td>
			<td></td>
			<td colspan="2"><p class="right"><img src="<?php echo realpath('image/iso.jpg'); ?>" height="120px" width="250px" align="center" /></p></td>
