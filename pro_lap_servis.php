...
<body>
	...
	date_default_timezone_set("asia/jakarta");
		...
		if($lap_svs_fak!=""){
			...
			$query=mysql_query("SELECT tbl_servis.*, 
								...
								tbl_kategori.*,
								tbl_satuan.*,
								(SELECT COUNT(tbl_servis_detail.svs_id) FROM tbl_servis_detail WHERE tbl_servis_detail.svs_id=tbl_servis.svs_id AND tbl_servis_detail.svs_serial!='') AS baris 
								FROM tbl_servis_detail
								INNER JOIN  tbl_servis ON tbl_servis.svs_id=tbl_servis_detail.svs_id
								INNER JOIN tbl_user ON tbl_user.usr_id=tbl_servis.usr_id
								INNER JOIN tbl_barang ON tbl_barang.brg_id=tbl_servis_detail.brg_id
								...
								ORDER BY tbl_servis.svs_id ASC ")or die(mysql_error());
		}else{
			$query=mysql_query("SELECT tbl_servis.*, 
								tbl_servis_detail.*,
								tbl_user.usr_id,tbl_user.usr_nama,
	...
	| <a href="pro_lap_servis_pdf.php?lap_svs_fak=<?php echo $lap_svs_fak; ?>&lap_tgl_awal_svs=<?php echo $lap_tgl_awal_svs; ?>&lap_tgl_akhir_svs=<?php echo $lap_tgl_akhir_svs; ?>&lap_svs_mbl_id=<?php echo $lap_svs_mbl_id; ?>&lap_svs_ktg_id=<?php echo $lap_svs_ktg; ?>">Export Pdf</a> | 
	<a href="pro_lap_servis_doc.php?lap_svs_fak=<?php echo $lap_svs_fak; ?>&lap_tgl_awal_svs=<?php echo $lap_tgl_awal_svs; ?>&lap_tgl_akhir_svs=<?php echo $lap_tgl_akhir_svs; ?>&lap_svs_mbl_id=<?php echo $lap_svs_mbl_id; ?>&lap_svs_ktg_id=<?php echo $lap_svs_ktg; ?>">Export Doc</a> | 
	<a href="pro_lap_servis_xls.php?lap_svs_fak=<?php echo $lap_svs_fak; ?>&lap_tgl_awal_svs=<?php echo $lap_tgl_awal_svs; ?>&lap_tgl_akhir_svs=<?php echo $lap_tgl_akhir_svs; ?>&lap_svs_mbl_id=<?php echo $lap_svs_mbl_id; ?>&lap_svs_ktg_id=<?php echo $lap_svs_ktg; ?>">Export Excel</a> | 
	<br /><br />
	 ...
	 <table width="98%" style="margin-left: 10px;font-size: 14px" class="colom">
		<tr>
			<td colspan="7"><p class="center"><img src="image/logo_wtp2.jpg" height="120px" width="320x" align="center" /></p></td>
			<td colspan="6"><p class="right"><img src="image/iso.jpg" height="100px" width="230px" align="center" /></p></td>
		</tr>
		<tr>
