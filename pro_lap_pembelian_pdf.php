...
<body>
	...
	date_default_timezone_set("asia/jakarta");
	 ...
	 ?>
	 <table width="98%" style="margin-left: 10px;font-size: 5px" class="colom table">
		<tr>
...
$pdf = new HTML2PDF('L','A4','en',true,'UTF-8',array(20,5,1,5));

$pdf->SetDefaultFont('Times','',5,'','');
$pdf->pdf->SetDisplayMode('real');

// $pdf->AddPage();
$pdf->WriteHTML($html);
$pdf->Output('Laporan-Pembelian.pdf','D');
?>
