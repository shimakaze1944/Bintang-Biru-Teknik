...
<body>
	<?php 
		...
		@$lap_tgl_akhir_klm=$_GET['lap_tgl_akhir_klm'];
				...
				if($lap_mbl_id!="" && $lap_tgl_awal_klm!="" && $lap_tgl_akhir_klm !=""){
						$query=mysql_query("SELECT tbl_klaim.*,
											tbl_klaim_detail.*,
											tbl_mobil.mbl_id, tbl_mobil.mbl_nopol,
											tbl_user.usr_id, tbl_user.usr_nama,
											(SELECT COUNT(tbl_klaim_detail.mbl_id)FROM tbl_klaim_detail WHERE tbl_klaim_detail.mbl_id='$lap_mbl_id'  AND tbl_klaim_detail.klm_dt_tgl BETWEEN '$lap_tgl_awal_klm' AND '$lap_tgl_akhir_klm') AS jumlah,
											...
											(SELECT SUM(tbl_klaim_detail.klm_dt_harga )FROM tbl_klaim_detail WHERE tbl_klaim_detail.mbl_id='$lap_mbl_id'  AND tbl_klaim_detail.klm_dt_tgl BETWEEN '$lap_tgl_awal_klm' AND '$lap_tgl_akhir_klm') AS total
	 ...
	 ?>
	 | <a href="pro_lap_klaim_pdf.php?lap_mbl_id=<?php echo $lap_mbl_id; ?>&lap_tgl_awal_klm=<?php echo $lap_tgl_awal_klm; ?>&lap_tgl_akhir_klm=<?php echo $lap_tgl_akhir_klm; ?>">Export Pdf</a> |
	 | <a href="pro_lap_klaim_doc.php?lap_mbl_id=<?php echo $lap_mbl_id; ?>&lap_tgl_awal_klm=<?php echo $lap_tgl_awal_klm; ?>&lap_tgl_akhir_klm=<?php echo $lap_tgl_akhir_klm; ?>">Export Doc</a> |
	 | <a href="pro_lap_klaim_xls.php?lap_mbl_id=<?php echo $lap_mbl_id; ?>&lap_tgl_awal_klm=<?php echo $lap_tgl_awal_klm; ?>&lap_tgl_akhir_klm=<?php echo $lap_tgl_akhir_klm; ?>">Export Excel</a> |
	 | <a href="pro_lap_klaim_sumxls.php?lap_mbl_id=<?php echo $lap_mbl_id; ?>&lap_tgl_awal_klm=<?php echo $lap_tgl_awal_klm; ?>&lap_tgl_akhir_klm=<?php echo $lap_tgl_akhir_klm; ?>">Rekap Laporan Excel</a> |

	 <br /><br />
	 <table width="98%" style="margin-left: 10px;font-size: 14px" class="colom">
		<tr>
			<td colspan="4"><p class="center"><img src="image/logo_wtp2.jpg" height="120px" width="320x" align="center" /></p></td>
			<td colspan="3"><p class="right"><img src="image/iso.jpg" height="100px" width="230px" align="center" /></p></td>
		</tr>
		<tr>
		...
		?>
							<td class='center colom' ><?php echo $array['mbl_nopol']; ?> </td>
		 					<td class='center colom' ><?php echo date ('d-m-Y', strtotime($array['klm_dt_tgl'])); ?> </td>
