...
<body>
	...
	| <a href="pro_lap_pembelian_pdf.php?lap_pbl_fak=<?php echo $lap_pbl_fak; ?>&lap_tgl_awal_beli=<?php echo $lap_tgl_awal_pbl; ?>&lap_tgl_akhir_beli=<?php echo $lap_tgl_akhir_pbl; ?>">Export Pdf</a> | <a href="pro_lap_pembelian_doc.php?lap_pbl_fak=<?php echo $lap_pbl_fak; ?>&lap_tgl_awal_beli=<?php echo $lap_tgl_awal_pbl; ?>&lap_tgl_akhir_beli=<?php echo $lap_tgl_akhir_pbl; ?>">Export Doc</a> | <a href="pro_lap_pembelian_xls.php?lap_pbl_fak=<?php echo $lap_pbl_fak; ?>&lap_tgl_awal_beli=<?php echo $lap_tgl_awal_pbl; ?>&lap_tgl_akhir_beli=<?php echo $lap_tgl_akhir_pbl; ?>">Export Excel</a>
	<br /><br />
